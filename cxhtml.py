...
def main():
    nickname = ''
    while nickname == '':
        nickname = input("Customer Name (Brief): ")
...
def head(nickname):
    ...
    head += 'p {margin: 0;}\n'
    head += '\n'
    head += 'p#serif {font-family: serif;}\n'
    head += 'p#sans-serif {font-family: sans-serif;}\n'
    head += 'p#monospace {font-family: monospace;}\n'
    head += 'p#fantasy {font-family: fantasy;}\n'
    head += 'p#cursive {font-family: cursive;}\n'
    head += '\n'
